...
// GenMan generates man pages for the given root command.
func GenMan(root *cobra.Command) *cobra.Command {
	cmd := &cobra.Command{
		Use:    "gen-man",
		Hidden: true,
...
// GenMD generates markdown documentation for the given root command.
func GenMD(root *cobra.Command) *cobra.Command {
	cmd := &cobra.Command{
		Use:    "gen-md",
		Hidden: true,
